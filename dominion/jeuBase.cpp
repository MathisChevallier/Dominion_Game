...
const Tresor *CUIVRE = new Tresor("Cuivre", 0, 1, 3);
const Tresor *ARGENT = new Tresor("Argent", 3, 2, 50);
const Tresor *OR     = new Tresor("Or",     6, 3, 80);

// Creation Cartes Victoire
const Victoire *PROVINCE    = new Victoire("Province"   , 8, 6, 99);
const Victoire *DUCHE       = new Victoire("Duche"      , 5, 3, 70);
const Victoire *DOMAINE     = new Victoire("Domaine"    , 2, 1, 9);
const Victoire *MALEDICTION = new Victoire("Malédiction", 0, -1, 1, "\033[35m");
...
const Action *CAVE             = new Action("Cave"              , 2, {"+1 Action", "effet Cave"}, "+1 Action ; Défaussez autant de cartes que vous voulez. +1 Carte par carte défaussée.", 45);
...
const Action *CHAPELLE         = new Action("Chapelle"         , 2, {"effet Chapelle"}, "Ecartez jusqu'à 4 cartes de votre main.", 60);
...
const ActionAttaque *BUREAUCRATE = new ActionAttaque("Bureaucrate", 4, {}, "Recevez 1 carte Argent : placez-la sur votre deck. Tous vos adversaires dévoilent 1 carte Victoire et la placent sur leur deck (sinon ils dévoilent leur main afin que vous puissiez voir qu'ils n'ont pas de cartes Victoire. ", {"effet Bureaucrate"}, 40);
...
const ActionReaction *DOUVES = new ActionReaction("Douves", 2, {"+1 Carte", "+1 Carte"}, "\033[0m+2 Cartes ; \033[34mLorsqu'un adversaire joue une carte Attaque, vous pouvez dévoiler cette carte de votre main. Dans ce cas, l'Attaque n'a pas d'effet sur vous. \033[0m", {"effet Douves"}, 50);

const RoyaumeVictoire *JARDINS = new RoyaumeVictoire("Jardins", 4, {"effet Jardins"}, "\033[32mVaut 1 Point de Victoire pour chaque 10 cartes dans votre deck (arrondi à l'unité inférieure). \033[0m", 50);
